...
accountsservice dialog fakeroot gcc inetutils make man-db man-pages most nano nbd net-tools netctl pv rsync sudo timelineproject-hg vi \
eza pocl \
...
openssl \
athena-neofetch-config athena-nvim-config athena-powershell-config athena-config athena-tmux-config athena-vim-config athena-zsh htb-toolkit nist-feed \
